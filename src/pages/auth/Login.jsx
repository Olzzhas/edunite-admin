...
const Login = () => {
   ...
   return (
      <div className="min-h-screen flex items-center justify-center bg-secondary py-12 px-4 sm:px-6 lg:px-8 font-sf">
         <div className="max-w-md w-full space-y-8">
            <div>
               <h2 className="mt-6 text-center text-3xl font-sf-medium">Sign in to Edunite</h2>
               <p className="mt-2 text-center text-sm text-tertiary font-sf-regular">Empowering Education Management</p>
            </div>
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
               ...
               <div>
                  <button
                     type="submit"
                     disabled={loading}
                     className={`group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-sf-regular rounded-md text-white ${
                        theme === "light" ? "bg-gray-800 hover:bg-gray-900" : "bg-primary-600 hover:bg-primary-700"
