...
const Semesters = () => {
   ...
   return (
      <div className="p-6">
                        ...
                        <div className="flex justify-between items-start">
                           <div>
                              ...
                              <div className="flex items-center text-sm text-gray-600 mb-2">
                                 ...
                                 <span>
                                    {formatTimestamp(semester.start_date || semester.startDate)} -{" "}
                                    {formatTimestamp(semester.end_date || semester.endDate)}
                                 </span>
                              </div>
                                          ...
                                          .map((breakItem) => (
                                             <div key={breakItem.id} className="flex items-center text-sm">
                                                ...
                                                <span className="font-medium mr-2">
                                                   {breakItem.description || breakItem.name}:
                                                </span>
                                                <span className="text-gray-600">{formatTimestamp(breakItem.break_date)}</span>
                                             </div>
                                          ))}
                                    </div>
                                 </div>
         ...
         {/* Add Semester Modal */}
         <AddSemesterModal isOpen={isAddSemesterModalOpen} onClose={handleCloseAddSemesterModal} onSubmit={handleAddSemester} />
      </div>
   );
};
