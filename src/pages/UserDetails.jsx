            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               ...
               <div className="bg-white rounded-lg shadow-sm p-6">
                  <div className="flex flex-col items-center">
                     ...
                     <h2 className="text-xl font-sf-regular">
                  ...
                  <div className="mt-6 border-t border-gray-200 pt-4">
                     <div className="flex items-center py-2">
                        ...
                        <span className="ml-auto text-sm">{formatDate(selectedUser.created_at || selectedUser.createdAt)}</span>
                     </div>
                     <div className="flex items-center py-2">
                        <FiCalendar className="text-gray-400 mr-2" />
                        <span className="text-sm text-gray-600">Updated:</span>
                        <span className="ml-auto text-sm">{formatDate(selectedUser.updated_at || selectedUser.updatedAt)}</span>
                     </div>
               ...
               <div className="md:col-span-2 bg-white rounded-lg shadow-sm p-6">
                  <h2 className="text-xl font-sf-medium mb-6">{isEditing ? "Edit User Information" : "User Information"}</h2>
                  ...
                  <form onSubmit={handleSubmit}>
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                           <label htmlFor="name" className="block text-sm font-sf-regular text-gray-700 mb-1">
                        ...
                        <div>
                           <label htmlFor="surname" className="block text-sm font-sf-regular text-gray-700 mb-1">
                        ...
                        <div>
                           <label htmlFor="email" className="block text-sm font-sf-regular text-gray-700 mb-1">
                        ...
                        <div>
                           <label htmlFor="role" className="block text-sm font-sf-regular text-gray-700 mb-1">
